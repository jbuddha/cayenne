...
/**
 * Gradle plugin to perform class generation from data map. This class is an Gradle
 * adapter to DefaultClassGenerator class.
 *
 */
public class CayenneGeneratorPlugin implements Plugin<Project> {
    ...
    public void apply(Project project) {
        ...
        Log logger = LogFactory.getLog(CayenneGeneratorPlugin.class.getName());
